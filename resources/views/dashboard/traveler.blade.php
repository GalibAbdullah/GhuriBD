...
@section('sidebar')
    <a href="{{ route('traveler.explore') }}" class="nav-item @yield('active-home')">
    ...
    <div class="mb-6">
        ...
        <div class="card card-pad">
            <div class="empty-state">
                ...
                <div class="mt-4">
                    <a href="{{ route('traveler.explore') }}" class="btn btn-primary btn-sm">Start exploring</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="card card-pad">
            <div class="empty-state">
                ...
                <div class="mt-4">
                    <a href="{{ route('traveler.explore') }}" class="btn btn-outline btn-sm">Explore Bangladesh</a>
                </div>
            </div>
        </div>
    </div>
