...
@section('content')
    <div class="mb-3">
        <a href="{{ route($isAdmin ? 'admin.resorts.rooms.index' : 'partner.resorts.rooms.index', $resort) }}" class="small fw-semibold link-secondary link-underline-opacity-0">
            &larr; Back to Rooms
        </a>
    </div>
    ...
    <div class="mb-4 d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            @unless ($isAdmin)
                <a href="{{ route('partner.resorts.rooms.edit', [$resort, $room]) }}" class="btn btn-outline-secondary btn-sm">Edit Room</a>
            @endunless
        </div>
    </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex justify-content-between px-0 py-2">
                            <span class="text-secondary">Available / Total</span>
                            <span class="text-body fw-semibold">{{ $room->available_rooms }} / {{ $room->total_rooms }}</span>
                        </div>
                    </div>
                </div>
            </div>
