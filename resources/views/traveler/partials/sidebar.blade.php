...
<a href="{{ route('tour-plans.index') }}" class="list-group-item list-group-item-action d-flex align-items-center gap-2 border-0 rounded {{ request()->routeIs('tour-plans.*') ? 'active bg-primary-subtle text-primary-emphasis fw-semibold' : '' }}">
...
<a href="{{ route('traveler.bookings.index') }}" class="list-group-item list-group-item-action d-flex align-items-center gap-2 border-0 rounded {{ request()->routeIs('traveler.bookings.*') || request()->routeIs('bookings.*') ? 'active bg-primary-subtle text-primary-emphasis fw-semibold' : '' }}">
