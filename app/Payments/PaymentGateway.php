...
interface PaymentGateway
{
    ...
    /**
     * Interpret a gateway callback/webhook against a specific payment attempt.
     * Does not itself mutate the Payment or Booking — the caller decides how
     * to apply the result inside its own transaction.
     */
